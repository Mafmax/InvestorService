...
namespace Mafmax.InvestorService.Model.Context
{
    ...
    public static class InvestorDbContextSeed
    {
        ...
        /// <returns></returns>
        public static async Task SeedDatabaseAsync(this InvestorDbContext context)
        {
        ...
        private static async Task<StockExchangeEntity[]> SeedStockExchangesAsync(InvestorDbContext context)
        {
        ...
        private static async Task<CountryEntity[]> SeedCountriesAsync(InvestorDbContext context)
        {
        ...
        private static async Task<IndustryEntity[]> SeedIndustriesAsync(InvestorDbContext context)
        {
            await context.Industries.AddRangeAsync(new IndustryEntity[]
            {
                new(){Name="Технологии"},
                new(){Name="Финансы"},
                new(){Name="Добыча ископаемых"},
                new(){Name="Нефть и газ"},
                new(){Name="Телекоммуникации"},
                new(){Name="IT"},
            });
        ...
        private static async Task<IssuerEntity[]> SeedIssuersAsync(InvestorDbContext context, CountryEntity[] countries, IndustryEntity[] industries)
        {
            await context.Issuers.AddRangeAsync(new IssuerEntity[]
            {
                new() {Country = countries[0],Industry = industries[4],Name="МТС" },
                new() {Country = countries[0],Industry = industries[3],Name="Сургутнефтегаз" },
                new() {Country = countries[0],Industry = industries[2],Name="Алроса" },
                new() {Country = countries[1],Industry = industries[0],Name="Apple" },
                new() {Country = countries[0],Industry = industries[5],Name="Яндекс" },
                new() {Country = countries[0],Industry = industries[1],Name="Сбербанк России" },
            });
        ...
        private static async Task<AssetEntity[]> SeedAssetsAsync(InvestorDbContext context, IssuerEntity[] issuers, StockExchangeEntity[] stockExchanges)
        {
